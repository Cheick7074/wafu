  ...
  return (
    <div className="flex w-screen h-screen inset-0 items-center justify-center z-50">
      <div className="relative z-20 border border-blue-500 py-20 px-14 flex flex-col align-top rounded-xl text-center">
        <p className="text-xl font-medium my-9 flex-wrap">Cette page contient du contenue sexuel qui serait inadapté pour certainnes personne<span className="text-red-500">Avez vous 18 ans ?</span></p>
        <div>
          <button
